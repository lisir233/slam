...
if("TRUE" STREQUAL "TRUE")
  set(euclidean_cluster_SOURCE_PREFIX /home/loop/ros_workspace/cartographer_detailed_comments_ws/src/euclidean_cluster)
  set(euclidean_cluster_DEVEL_PREFIX /home/loop/ros_workspace/cartographer_detailed_comments_ws/devel_isolated/euclidean_cluster)
  ...
  set(euclidean_cluster_INSTALL_PREFIX /home/loop/ros_workspace/cartographer_detailed_comments_ws/install_isolated)
...
if(NOT "/home/loop/ros_workspace/cartographer_detailed_comments_ws/src/euclidean_cluster/include " STREQUAL " ")
  set(euclidean_cluster_INCLUDE_DIRS "")
  set(_include_dirs "/home/loop/ros_workspace/cartographer_detailed_comments_ws/src/euclidean_cluster/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'euclidean_cluster' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/loop/ros_workspace/cartographer_detailed_comments_ws/src/euclidean_cluster/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT euclidean_cluster_NUM_DUMMY_TARGETS)
      set(euclidean_cluster_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::euclidean_cluster::wrapped-linker-option${euclidean_cluster_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR euclidean_cluster_NUM_DUMMY_TARGETS "${euclidean_cluster_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::euclidean_cluster::wrapped-linker-option${euclidean_cluster_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND euclidean_cluster_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/loop/ros_workspace/cartographer_detailed_comments_ws/devel_isolated/euclidean_cluster/lib;/home/loop/ros_workspace/cartographer_detailed_comments_ws/devel_isolated/pointcloud_deal/lib;/home/loop/ros_workspace/cartographer_detailed_comments_ws/install_isolated/lib;/opt/ros/noetic/lib)
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(euclidean_cluster_EXPORTED_TARGETS ${${euclidean_cluster_dep}_EXPORTED_TARGETS})
endforeach()
